...
class Lib():
    ...
    def delete_book(self, name_book): # Функция удаления книги
        ...
        except FileNotFoundError: print("Такой книги не существует")
